...
<link rel="stylesheet" href="styles/style.css">
  ...
  function fullScreen(){
   ...
   function back(){
    ...
    <!-- <div id="userInf5" style="position: absolute; width: 355px; height: 28px; z-indent: 2; left: 200px; top: 550px; display:block; ">
                  <span id="userInfo5">    <font size="-1" color="#FFFFFF">
                  		<button onclick="fullScreen();"> <img id="userInfo5" src="../content/images/2.jpg" alt="SHOW" /> </button>
