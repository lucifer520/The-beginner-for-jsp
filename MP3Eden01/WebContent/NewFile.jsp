...
<body onload="test();">
 ...
 <script >
	...
	<%session.setAttribute("uses", use);%>
	  <% if(use!=null)
		   {%>
			   userInfo5.style.display="none";
			   document.getElementById("userInfo6").innerHTML="<%=use%>"+ "&nbsp;&nbsp;<a href='javascript:void(0);' onclick='back();InvalidataServlet;'>退出"+"</a>";
...
%>
    <li>
        ...
        <a href="index.jsp"><%=mUpFile.getFile_name() %></a> 
